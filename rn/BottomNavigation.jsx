...
const BottomNavigation = () => {
  return (
    <Tab.Navigator  screenOptions={{ tabBarIconStyle: { opacity: 0.8 }, header: () => <Header />, tabBarStyle: { backgroundColor: "#020202", height: 60, paddingTop: 10 }, tabBarLabelStyle: { color: '#ffffff' }, tabBarLabelPosition: 'below-icon' }}>
